...
const clientProjects = [
  ...
  },
  {
    ...
    tech: ["Laravel", "MySQL", "Payment Gateway", "Bootstrap"],
  ...
  },
  {
    ...
    tech: ["Laravel", "MySQL", "REST API", "jQuery"],
  ...
  },
  {
    ...
    tech: ["Laravel", "AI Integration", "MySQL", "Vue.js"],
  ...
  },
  {
    ...
    tech: ["Laravel", "MySQL", "WebSocket", "React"],
  ...
  },
  {
    ...
    tech: ["Laravel", "MySQL", "AWS S3", "Tailwind CSS"],
  ...
  },
  {
    ...
    tech: ["Laravel", "MySQL", "2FA", "REST API"],
    liveUrl: "https://privatetrust.gcpagroup.com",
    category: "Finance",
  },
  {
    title: "Micky&apos;s Liquor",
...
const personalProjects = [
  ...
  },
  {
    ...
    tech: ["Laravel", "Payment Gateway", "MySQL", "Tailwind"],
    liveUrl: "#",
    featured: true,
  },
  {
  ...
  },
  {
    ...
    tech: ["Laravel", "MySQL", "Payment Gateway"],
    liveUrl: "#",
    featured: false,
  },
  {
...
export function ProjectsSection() {
  ...
  return (
    <section id="projects" className="py-10 md:py-15 bg-muted/30">
